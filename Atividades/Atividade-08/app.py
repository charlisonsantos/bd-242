...
def main():
    ...
    create_funcionario(connection, 1, 1, "charlison", "santos", None, "francisco.charlison09@aluno.ifce.edu.br", None, "Designer chefe")
    create_produto(connection, 1, "Calça Cargo", 1, None, "EUA", "Calça", 245, 500, 80,)
